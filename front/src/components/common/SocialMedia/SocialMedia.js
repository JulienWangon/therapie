...
const SocialMedia = ({ className }) => {
  return (
    <div className={className}>
        <a href="https://www.instagram.com/marine.ottaviani?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className="socialContainer containerOne" target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://www.facebook.com/explorationdescorps" className="socialContainer containerTwo" target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://www.linkedin.com/in/marine-ottaviani-b6a1b1249/" className="socialContainer containerThree" target="_blank" rel="noopener noreferrer">
